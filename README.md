...
- Exec -> `npx eslint --init` (See file _`.eslintrc.json`_ & _`.eslintignore`_ & _`.lintstagedrc`_)
...
- Create a git hook to make a commit-msg and this run a regular expression validator before each commit
